...
export default async function ClienteEditarPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <PageShell kicker="Editar" title={c.nombre} actions={
      ...
      <Link href={`/clientes/${cid}`} className="text-fervor-smoke hover:text-fervor-flame inline-flex items-center gap-1 mb-4 text-sm">
